...
function init(){
  ...
  prevFrame = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  sceneTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  fbTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  diffTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  adds = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  addsRtt = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  blurHTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  blurVTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  glowTex = new THREE.WebGLRenderTarget(texW, texH, {minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
  ...
  glowShader = new THREE.ShaderMaterial({
    uniforms:{
      ...
      step: {type: 'v2', value: new THREE.Vector2(3.0/texW, 3.0/texH)},
      time: {type: 'f', value: time }
    },
    vertexShader: document.getElementById('vertexShader').textContent,
  ...
  loader.load('models/atrium.json', function (result){
   // assignUVs(result);
    ...
    //for(var i = 0; i< 4; i++){
      ...
      gate.scale.set(75,200,75);
      gate.position.set(0,-700,0);
      scene.add(gate);
      //gates.push(gate);
...
function render(){
  ...
  semShader.uniforms.time.value = time;
...
/*
  ...
  blurHShader.uniforms.step.value = new THREE.Vector2(3.0/texW, 3.0/texH);
